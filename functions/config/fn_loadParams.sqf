...
// The SOLE equipment source is dynamic, intent-aware discovery: it scans the
// loaded configs and publishes appropriate loot/airdrop/shop/clothing gear for
// whatever mods are running, with built-in vanilla classnames as fallbacks so a
// category is never left unset. There are no per-modpack preset files.
...
missionNamespace setVariable ["DetectiveEnabled",                   (param [21, 1]) != 0,      true];
